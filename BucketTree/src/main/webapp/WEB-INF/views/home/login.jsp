...
<body>
	...
	<div class="module form-module">
		...
		<div class="form1">
			...
			<form method="POST" action="user/create" onsubmit="return validate()"
				name="join">
				<input id="create_email" name="create_email" type="email"
					placeholder="Email Address" value="${UserVO.email}" /> <span
					id="duplicateResult1"> </span> <input id="create_pw"
					name="create_pw" type="password" placeholder="Password" /> <span
					id="duplicateResult2"> * 8~20자의 영문,숫자,특수문자 혼합 </span> <input
					id="create_pw2" name="create_pw2" type="password"
					placeholder="Password identify" /> <span id="duplicateResult3">
				</span> <input id="create_name" name="create_name" type="text"
					placeholder="Username" /> <input id="create_birth"
					name="create_birth" type="date" placeholder="BIRTH DAY" />
				<div class="g-recaptcha"
					data-sitekey="6LdPxigTAAAAADwG8VjJoQfXux6HIIZpr6vzEwrc"></div>
				...
				.keyup(
						function() {
							...
							if (regex.test(email) == false) {
								...
								$
										.post(
												'<c:url value="/user/checkDuplicateEmailAjax"/>',
												{
													'create_email' : $(
															'#create_email')
															.val()
												...
												function(data) {
													...
													if (data == "true") {
														document
																.getElementById("create_pw").style.marginTop = "20px";
														$('#idcheck').val('N');
														$('#duplicateResult1')
																.text(
																		"* 이미사용중인 이메일입니다.")
