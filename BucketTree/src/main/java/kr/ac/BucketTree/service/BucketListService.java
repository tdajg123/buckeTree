...
public interface BucketListService {
	...
	public List<BucketListVO> list(Pagination pagination, int user_idx)
			throws Exception; /* 전체 목록 및 정렬-최신순 */
	...
	public boolean titleCheck(String title, int userIdx)
	...
	public List<BucketListVO> recommendList(int fromUser)
			throws Exception; /* 친구 추천 */

	public List<BucketListVO> adminRecommendList(int user_idx)
			throws Exception; /* 관리자 추천 */
