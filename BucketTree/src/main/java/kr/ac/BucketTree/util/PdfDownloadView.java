...
public class PdfDownloadView extends AbstractIText5PdfView {
   ...
   protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
      ...
      try {
         ...
         String cover_Image = "http://localhost:8080/BucketTree/bucket/" + b_image + "/image";
         ...
         String Image1 = "http://localhost:8080/BucketTree/bucket/" + ji_1 + "/image";
         ...
         String Image2 = "http://localhost:8080/BucketTree/bucket/" + ji_2 + "/image";
         ...
         String Image3 = "http://localhost:8080/BucketTree/bucket/" + ji_3 + "/image";
         ...
         String Image4 = "http://localhost:8080/BucketTree/bucket/" + ji_4 + "/image";
         ...
         String Image5 = "http://localhost:8080/BucketTree/bucket/" + ji_5 + "/image";
         Image img5 = Image.getInstance(Image5);
         img5.scaleAbsolute(600, 400);
         img5.setAbsolutePosition(0, 200);
         document.add(img5);

         String ImageCali = "http://localhost:8080/BucketTree/images/cali.jpg";
         ...
         String Image6 = "http://localhost:8080/BucketTree/bucket/" + ji_6 + "/image";
         ...
         String Image7 = "http://localhost:8080/BucketTree/bucket/" + ji_7 + "/image";
         ...
         String Image8 = "http://localhost:8080/BucketTree/bucket/" + ji_8 + "/image";
